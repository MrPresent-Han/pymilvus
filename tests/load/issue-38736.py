...
round = 1
do_query = False
inserted_str = generate_random_string(1)
...
def main():
    ...
    if prepare_new_data:
        ...
        fields = [
            ...
            FieldSchema(name=ARR_FIELD, dtype=DataType.ARRAY, element_type=DataType.VARCHAR, max_length=10, max_capacity=10),
        ]
        ...
        for k in range(BATCH_COUNT):
            ...
            for i in range(NUM_ENTITIES*k, NUM_ENTITIES*(k+1)):
                entity = {
                    ...
                    ARR_FIELD: [inserted_str, inserted_str, inserted_str, inserted_str, inserted_str, inserted_str, inserted_str, inserted_str, inserted_str, inserted_str]
                }
