...
class PrewarmTaskState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    PrewarmTaskStateUnknown: _ClassVar[PrewarmTaskState]
    PrewarmTaskStatePending: _ClassVar[PrewarmTaskState]
    PrewarmTaskStateWarming: _ClassVar[PrewarmTaskState]
    PrewarmTaskStateCompleted: _ClassVar[PrewarmTaskState]
    PrewarmTaskStateFailed: _ClassVar[PrewarmTaskState]
...
class RowPolicyAction(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    QueryIterator: _ClassVar[RowPolicyAction]
    SearchIterator: _ClassVar[RowPolicyAction]
    HybridSearch: _ClassVar[RowPolicyAction]

class RowPolicyType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    RowPolicyTypeUnknown: _ClassVar[RowPolicyType]
    RowPolicyTypePermissive: _ClassVar[RowPolicyType]
    RowPolicyTypeRestrictive: _ClassVar[RowPolicyType]

class RestoreSnapshotState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    RestoreSnapshotNone: _ClassVar[RestoreSnapshotState]
    RestoreSnapshotPending: _ClassVar[RestoreSnapshotState]
...
PrewarmTaskStatePending: PrewarmTaskState
PrewarmTaskStateWarming: PrewarmTaskState
PrewarmTaskStateCompleted: PrewarmTaskState
PrewarmTaskStateFailed: PrewarmTaskState
...
QueryIterator: RowPolicyAction
SearchIterator: RowPolicyAction
HybridSearch: RowPolicyAction
RowPolicyTypeUnknown: RowPolicyType
RowPolicyTypePermissive: RowPolicyType
RowPolicyTypeRestrictive: RowPolicyType
RestoreSnapshotNone: RestoreSnapshotState
RestoreSnapshotPending: RestoreSnapshotState
...
class DescribeCollectionResponse(_message.Message):
    ...
    ROUTING_MODULUS_FIELD_NUMBER: _ClassVar[int]
    status: _common_pb2.Status
...
class PrewarmRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "namespace", "replica_number", "resource_groups", "load_fields", "skip_load_dynamic_field", "load_params", "ttl_seconds", "priority")
    class LoadParamsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    ttl_seconds: int
    priority: str
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., namespace: _Optional[str] = ..., replica_number: _Optional[int] = ..., resource_groups: _Optional[_Iterable[str]] = ..., load_fields: _Optional[_Iterable[str]] = ..., skip_load_dynamic_field: bool = ..., load_params: _Optional[_Mapping[str, str]] = ..., ttl_seconds: _Optional[int] = ..., priority: _Optional[str] = ...) -> None: ...

class PrewarmResponse(_message.Message):
    __slots__ = ("status", "taskID", "namespace")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    taskID: str
    namespace: str
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., taskID: _Optional[str] = ..., namespace: _Optional[str] = ...) -> None: ...

class DescribePrewarmTaskRequest(_message.Message):
    __slots__ = ("base", "taskID")
    BASE_FIELD_NUMBER: _ClassVar[int]
    TASKID_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
    taskID: str
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., taskID: _Optional[str] = ...) -> None: ...

class DescribePrewarmTaskResponse(_message.Message):
    __slots__ = ("status", "taskID", "state", "progress", "error_message")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    TASKID_FIELD_NUMBER: _ClassVar[int]
    ...
    status: _common_pb2.Status
    taskID: str
    state: PrewarmTaskState
    progress: int
    error_message: str
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., taskID: _Optional[str] = ..., state: _Optional[_Union[PrewarmTaskState, str]] = ..., progress: _Optional[int] = ..., error_message: _Optional[str] = ...) -> None: ...
...
class NamespaceStats(_message.Message):
    __slots__ = ("stats", "approx_entity_count", "entity_count", "entity_count_type", "logical_bytes", "last_write_timestamp", "last_write_utc_timestamp")
    STATS_FIELD_NUMBER: _ClassVar[int]
    APPROX_ENTITY_COUNT_FIELD_NUMBER: _ClassVar[int]
    ENTITY_COUNT_FIELD_NUMBER: _ClassVar[int]
    ENTITY_COUNT_TYPE_FIELD_NUMBER: _ClassVar[int]
    LOGICAL_BYTES_FIELD_NUMBER: _ClassVar[int]
    LAST_WRITE_TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    LAST_WRITE_UTC_TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    stats: _containers.RepeatedCompositeFieldContainer[_common_pb2.KeyValuePair]
    approx_entity_count: int
    entity_count: int
    entity_count_type: str
    logical_bytes: int
    last_write_timestamp: int
    last_write_utc_timestamp: int
    def __init__(self, stats: _Optional[_Iterable[_Union[_common_pb2.KeyValuePair, _Mapping]]] = ..., approx_entity_count: _Optional[int] = ..., entity_count: _Optional[int] = ..., entity_count_type: _Optional[str] = ..., logical_bytes: _Optional[int] = ..., last_write_timestamp: _Optional[int] = ..., last_write_utc_timestamp: _Optional[int] = ...) -> None: ...

class NamespaceInfo(_message.Message):
    __slots__ = ("collection_name", "namespace_name", "created_timestamp", "created_utc_timestamp", "state", "stats")
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, collection_name: _Optional[str] = ..., namespace_name: _Optional[str] = ..., created_timestamp: _Optional[int] = ..., created_utc_timestamp: _Optional[int] = ..., state: _Optional[str] = ..., stats: _Optional[_Union[NamespaceStats, _Mapping]] = ...) -> None: ...

class CreateNamespaceRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "namespace_name")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    collection_name: str
    namespace_name: str
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., namespace_name: _Optional[str] = ...) -> None: ...
...
class CreateNamespaceResponse(_message.Message):
    ...
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., namespace: _Optional[_Union[NamespaceInfo, _Mapping]] = ...) -> None: ...
...
class ListNamespacesRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "prefix", "page_size", "page_token")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    page_size: int
    page_token: str
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., prefix: _Optional[str] = ..., page_size: _Optional[int] = ..., page_token: _Optional[str] = ...) -> None: ...

class ListNamespacesResponse(_message.Message):
    __slots__ = ("status", "namespaces", "next_page_token")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    next_page_token: str
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., namespaces: _Optional[_Iterable[_Union[NamespaceInfo, _Mapping]]] = ..., next_page_token: _Optional[str] = ...) -> None: ...
...
class HasNamespaceRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "namespace_name")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
...
class HasNamespaceResponse(_message.Message):
    __slots__ = ("status", "value")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    status: _common_pb2.Status
...
class GetNamespaceStatsRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "namespace_name", "exact")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    namespace_name: str
    exact: bool
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., namespace_name: _Optional[str] = ..., exact: bool = ...) -> None: ...

class GetNamespaceStatsResponse(_message.Message):
    __slots__ = ("status", "namespace_name", "stats")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_NAME_FIELD_NUMBER: _ClassVar[int]
    STATS_FIELD_NUMBER: _ClassVar[int]
    status: _common_pb2.Status
    namespace_name: str
    stats: NamespaceStats
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., namespace_name: _Optional[str] = ..., stats: _Optional[_Union[NamespaceStats, _Mapping]] = ...) -> None: ...
...
class InsertRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "partition_name", "fields_data", "hash_keys", "num_rows", "schema_timestamp", "namespace", "rls_principal", "skip_rls")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    PARTITION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    RLS_PRINCIPAL_FIELD_NUMBER: _ClassVar[int]
    SKIP_RLS_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
    db_name: str
    collection_name: str
    partition_name: str
...
class UpsertRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "partition_name", "fields_data", "hash_keys", "num_rows", "schema_timestamp", "partial_update", "namespace", "field_ops", "rls_principal", "skip_rls")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    PARTITION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    FIELD_OPS_FIELD_NUMBER: _ClassVar[int]
    RLS_PRINCIPAL_FIELD_NUMBER: _ClassVar[int]
    SKIP_RLS_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
    db_name: str
    ...
    partial_update: bool
    namespace: str
    field_ops: _containers.RepeatedCompositeFieldContainer[_schema_pb2.FieldPartialUpdateOp]
    rls_principal: str
    skip_rls: bool
...
class DeleteRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "partition_name", "expr", "hash_keys", "consistency_level", "expr_template_values", "namespace", "rls_principal", "skip_rls")
...
class SubSearchRequest(_message.Message):
    __slots__ = ("dsl", "placeholder_group", "dsl_type", "search_params", "nq", "expr_template_values", "namespace", "function_chains")
    class ExprTemplateValuesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    EXPR_TEMPLATE_VALUES_FIELD_NUMBER: _ClassVar[int]
    NAMESPACE_FIELD_NUMBER: _ClassVar[int]
    FUNCTION_CHAINS_FIELD_NUMBER: _ClassVar[int]
    dsl: str
    ...
    expr_template_values: _containers.MessageMap[str, _schema_pb2.TemplateValue]
    namespace: str
    function_chains: _containers.RepeatedCompositeFieldContainer[_schema_pb2.FunctionChain]
...
class SearchRequest(_message.Message):
    ...
    SEARCH_AGGREGATION_FIELD_NUMBER: _ClassVar[int]
    FUNCTION_CHAINS_FIELD_NUMBER: _ClassVar[int]
    RLS_PRINCIPAL_FIELD_NUMBER: _ClassVar[int]
    SKIP_RLS_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
    ...
    search_aggregation: _common_pb2.SearchAggregationSpec
    function_chains: _containers.RepeatedCompositeFieldContainer[_schema_pb2.FunctionChain]
    rls_principal: str
    skip_rls: bool
...
class HybridSearchRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "partition_names", "requests", "rank_params", "travel_timestamp", "guarantee_timestamp", "not_return_all_meta", "output_fields", "consistency_level", "use_default_consistency", "function_score", "namespace", "function_chains", "rls_principal", "skip_rls")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    PARTITION_NAMES_FIELD_NUMBER: _ClassVar[int]
...
class QueryRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "expr", "output_fields", "partition_names", "travel_timestamp", "guarantee_timestamp", "query_params", "not_return_all_meta", "consistency_level", "use_default_consistency", "expr_template_values", "namespace", "rls_principal", "skip_rls")
    class ExprTemplateValuesEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class CompactionMergeInfo(_message.Message):
    ...
    def __init__(self, sources: _Optional[_Iterable[int]] = ..., target: _Optional[int] = ..., plan_id: _Optional[int] = ..., trigger_id: _Optional[int] = ..., collection_id: _Optional[int] = ..., partition_id: _Optional[int] = ..., channel: _Optional[str] = ..., type: _Optional[str] = ..., state: _Optional[str] = ..., failure_reason: _Optional[str] = ..., targets: _Optional[_Iterable[int]] = ...) -> None: ...
...
class CreateRowPolicyRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "policy_name", "actions", "roles", "using_expr", "check_expr", "description", "policy_type")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
...
class UpdateRowPolicyRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "policy_name", "actions", "roles", "using_expr", "check_expr", "description", "policy_type")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
...
class RowPolicy(_message.Message):
    __slots__ = ("policy_name", "actions", "roles", "using_expr", "check_expr", "description", "created_at", "policy_type")
    POLICY_NAME_FIELD_NUMBER: _ClassVar[int]
    ACTIONS_FIELD_NUMBER: _ClassVar[int]
    ROLES_FIELD_NUMBER: _ClassVar[int]
    USING_EXPR_FIELD_NUMBER: _ClassVar[int]
    ...
    created_at: int
    policy_type: RowPolicyType
    def __init__(self, policy_name: _Optional[str] = ..., actions: _Optional[_Iterable[_Union[RowPolicyAction, str]]] = ..., roles: _Optional[_Iterable[str]] = ..., using_expr: _Optional[str] = ..., check_expr: _Optional[str] = ..., description: _Optional[str] = ..., created_at: _Optional[int] = ..., policy_type: _Optional[_Union[RowPolicyType, str]] = ...) -> None: ...
...
class SetRLSPrincipalTagsRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "principal_name", "tags")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    principal_name: str
    tags: str
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., principal_name: _Optional[str] = ..., tags: _Optional[str] = ...) -> None: ...

class GetRLSPrincipalTagsRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "principal_name")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    PRINCIPAL_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    collection_name: str
    principal_name: str
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., principal_name: _Optional[str] = ...) -> None: ...

class GetRLSPrincipalTagsResponse(_message.Message):
    __slots__ = ("status", "tags", "db_name", "collection_name", "principal_name")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    TAGS_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    collection_name: str
    principal_name: str
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., tags: _Optional[str] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., principal_name: _Optional[str] = ...) -> None: ...

class ListRLSPrincipalsRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
...
class ListRLSPrincipalsResponse(_message.Message):
    __slots__ = ("status", "principal_names", "db_name", "collection_name")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    PRINCIPAL_NAMES_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    status: _common_pb2.Status
    principal_names: _containers.RepeatedScalarFieldContainer[str]
    db_name: str
    collection_name: str
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., principal_names: _Optional[_Iterable[str]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ...) -> None: ...

class DeleteRLSPrincipalTagsRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name", "principal_name", "tag_keys")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    PRINCIPAL_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    principal_name: str
    tag_keys: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., principal_name: _Optional[str] = ..., tag_keys: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ComputePhraseMatchSlopRequest(_message.Message):
    __slots__ = ("base", "analyzer_params", "query_text", "data_texts")
    BASE_FIELD_NUMBER: _ClassVar[int]
    ANALYZER_PARAMS_FIELD_NUMBER: _ClassVar[int]
    QUERY_TEXT_FIELD_NUMBER: _ClassVar[int]
    DATA_TEXTS_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
    analyzer_params: str
    query_text: str
    data_texts: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., analyzer_params: _Optional[str] = ..., query_text: _Optional[str] = ..., data_texts: _Optional[_Iterable[str]] = ...) -> None: ...

class ComputePhraseMatchSlopResponse(_message.Message):
    __slots__ = ("status", "is_match", "slops")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    IS_MATCH_FIELD_NUMBER: _ClassVar[int]
    SLOPS_FIELD_NUMBER: _ClassVar[int]
    status: _common_pb2.Status
    is_match: _containers.RepeatedScalarFieldContainer[bool]
    slops: _containers.RepeatedScalarFieldContainer[int]
...
class CreateSnapshotRequest(_message.Message):
    __slots__ = ("base", "name", "description", "db_name", "collection_name", "compaction_protection_seconds", "skip_index")
    BASE_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    SKIP_INDEX_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
    name: str
    description: str
    db_name: str
    ...
    skip_index: bool
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., compaction_protection_seconds: _Optional[int] = ..., skip_index: bool = ...) -> None: ...
...
class DescribeSnapshotResponse(_message.Message):
    __slots__ = ("status", "name", "description", "collection_name", "partition_names", "create_ts", "s3_location", "skip_index")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    s3_location: str
    skip_index: bool
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., collection_name: _Optional[str] = ..., partition_names: _Optional[_Iterable[str]] = ..., create_ts: _Optional[int] = ..., s3_location: _Optional[str] = ..., skip_index: bool = ...) -> None: ...

class RestoreSnapshotRequest(_message.Message):
    __slots__ = ("base", "name", "db_name", "collection_name", "rewrite_data", "target_db_name", "target_collection_name", "skip_index")
    BASE_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    skip_index: bool
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., name: _Optional[str] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., rewrite_data: bool = ..., target_db_name: _Optional[str] = ..., target_collection_name: _Optional[str] = ..., skip_index: bool = ...) -> None: ...
...
class RestoreExternalSnapshotRequest(_message.Message):
    __slots__ = ("base", "db_name", "target_collection_name", "snapshot_metadata_uri", "external_spec", "skip_index")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    TARGET_COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    external_spec: str
    skip_index: bool
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., target_collection_name: _Optional[str] = ..., snapshot_metadata_uri: _Optional[str] = ..., external_spec: _Optional[str] = ..., skip_index: bool = ...) -> None: ...

class RestoreExternalSnapshotResponse(_message.Message):
    __slots__ = ("status", "job_id")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    JOB_ID_FIELD_NUMBER: _ClassVar[int]
    status: _common_pb2.Status
...
class ExportSnapshotRequest(_message.Message):
    __slots__ = ("base", "name", "db_name", "collection_name", "target_s3_path", "external_spec")
    BASE_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    TARGET_S3_PATH_FIELD_NUMBER: _ClassVar[int]
    EXTERNAL_SPEC_FIELD_NUMBER: _ClassVar[int]
    base: _common_pb2.MsgBase
    name: str
    db_name: str
...
class RestoreSnapshotInfo(_message.Message):
    ...
    start_time: int
    time_cost: int
    def __init__(self, job_id: _Optional[int] = ..., snapshot_name: _Optional[str] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., state: _Optional[_Union[RestoreSnapshotState, str]] = ..., progress: _Optional[int] = ..., reason: _Optional[str] = ..., start_time: _Optional[int] = ..., time_cost: _Optional[int] = ...) -> None: ...

class GetRestoreSnapshotStateRequest(_message.Message):
...
class GetRestoreSnapshotStateResponse(_message.Message):
    __slots__ = ("status", "info")
    STATUS_FIELD_NUMBER: _ClassVar[int]
    INFO_FIELD_NUMBER: _ClassVar[int]
    status: _common_pb2.Status
    info: RestoreSnapshotInfo
    def __init__(self, status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ..., info: _Optional[_Union[RestoreSnapshotInfo, _Mapping]] = ...) -> None: ...

class ListRestoreSnapshotJobsRequest(_message.Message):
    __slots__ = ("base", "db_name", "collection_name")
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
...
class ListRestoreSnapshotJobsResponse(_message.Message):
...
class AlterCollectionSchemaRequest(_message.Message):
    ...
    class FieldInfo(_message.Message):
        __slots__ = ("field_schema", "index_name", "extra_params")
        FIELD_SCHEMA_FIELD_NUMBER: _ClassVar[int]
        INDEX_NAME_FIELD_NUMBER: _ClassVar[int]
        EXTRA_PARAMS_FIELD_NUMBER: _ClassVar[int]
        field_schema: _schema_pb2.FieldSchema
        index_name: str
        extra_params: _containers.RepeatedCompositeFieldContainer[_common_pb2.KeyValuePair]
        def __init__(self, field_schema: _Optional[_Union[_schema_pb2.FieldSchema, _Mapping]] = ..., index_name: _Optional[str] = ..., extra_params: _Optional[_Iterable[_Union[_common_pb2.KeyValuePair, _Mapping]]] = ...) -> None: ...
    class AddRequest(_message.Message):
        __slots__ = ("field_infos", "func_schema", "do_physical_backfill")
        FIELD_INFOS_FIELD_NUMBER: _ClassVar[int]
        FUNC_SCHEMA_FIELD_NUMBER: _ClassVar[int]
        DO_PHYSICAL_BACKFILL_FIELD_NUMBER: _ClassVar[int]
        field_infos: _containers.RepeatedCompositeFieldContainer[AlterCollectionSchemaRequest.FieldInfo]
        func_schema: _containers.RepeatedCompositeFieldContainer[_schema_pb2.FunctionSchema]
    ...
    class DropRequest(_message.Message):
        __slots__ = ("field_name", "field_id", "function_name", "drop_function_output_fields")
        FIELD_NAME_FIELD_NUMBER: _ClassVar[int]
        FIELD_ID_FIELD_NUMBER: _ClassVar[int]
        FUNCTION_NAME_FIELD_NUMBER: _ClassVar[int]
        DROP_FUNCTION_OUTPUT_FIELDS_FIELD_NUMBER: _ClassVar[int]
        field_name: str
        field_id: int
        function_name: str
        drop_function_output_fields: bool
        def __init__(self, field_name: _Optional[str] = ..., field_id: _Optional[int] = ..., function_name: _Optional[str] = ..., drop_function_output_fields: bool = ...) -> None: ...
    class Action(_message.Message):
        __slots__ = ("add_request", "drop_request")
        ADD_REQUEST_FIELD_NUMBER: _ClassVar[int]
        DROP_REQUEST_FIELD_NUMBER: _ClassVar[int]
        add_request: AlterCollectionSchemaRequest.AddRequest
        drop_request: AlterCollectionSchemaRequest.DropRequest
        def __init__(self, add_request: _Optional[_Union[AlterCollectionSchemaRequest.AddRequest, _Mapping]] = ..., drop_request: _Optional[_Union[AlterCollectionSchemaRequest.DropRequest, _Mapping]] = ...) -> None: ...
    BASE_FIELD_NUMBER: _ClassVar[int]
    DB_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_NAME_FIELD_NUMBER: _ClassVar[int]
    COLLECTIONID_FIELD_NUMBER: _ClassVar[int]
    ...
    collection_name: str
    collectionID: int
    action: AlterCollectionSchemaRequest.Action
    def __init__(self, base: _Optional[_Union[_common_pb2.MsgBase, _Mapping]] = ..., db_name: _Optional[str] = ..., collection_name: _Optional[str] = ..., collectionID: _Optional[int] = ..., action: _Optional[_Union[AlterCollectionSchemaRequest.Action, _Mapping]] = ...) -> None: ...

class AlterCollectionSchemaResponse(_message.Message):
    __slots__ = ("alter_status",)
    ALTER_STATUS_FIELD_NUMBER: _ClassVar[int]
    alter_status: _common_pb2.Status
    def __init__(self, alter_status: _Optional[_Union[_common_pb2.Status, _Mapping]] = ...) -> None: ...
...
class GetClientTelemetryRequest(_message.Message):
    __slots__ = ("database", "client_id", "include_metrics", "command_id")
    ...
    command_id: str
    def __init__(self, database: _Optional[str] = ..., client_id: _Optional[str] = ..., include_metrics: bool = ..., command_id: _Optional[str] = ...) -> None: ...
